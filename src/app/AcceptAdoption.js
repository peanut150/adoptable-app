  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Text style={styles.greetingsText}>You accepted {'\n'} Mary Jane as Shiro’s fur parent.</Text>
        <Text style={styles.instructionText}>Shiro is one step closer to a loving home. Get ready to finalize the adoption process!</Text>
      </View>
    </SafeAreaView>
  );
}
